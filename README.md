...
- [Sylius/SyliusGridBundle](https://github.com/Sylius/SyliusGridBundle) ([v1.15.0-ALPHA.1](https://github.com/Sylius/SyliusGridBundle/releases/tag/v1.15.0-ALPHA.1), 6 days ago) - Generic data grids for Symfony applications, support Doctrine and custom drivers, sorting, filtering, actions and field types.
- [doctrine/orm](https://github.com/doctrine/orm) ([2.20.9](https://github.com/doctrine/orm/releases/tag/2.20.9), 1 week ago) - Doctrine Object Relational Mapper (ORM)
- [doctrine/DoctrineBundle](https://github.com/doctrine/DoctrineBundle) ([3.1.0](https://github.com/doctrine/DoctrineBundle/releases/tag/3.1.0), 1 week ago) - Symfony Bundle for Doctrine ORM and DBAL
- [Sylius/Sylius](https://github.com/Sylius/Sylius) ([v2.1.8](https://github.com/Sylius/Sylius/releases/tag/v2.1.8), 1 week ago) - Headless open-source eCommerce platform on top of PHP/Symfony/API Platform
...
- [Sylius/Stack](https://github.com/Sylius/Stack) - The Sylius stack is a set of tools for your Symfony projects. (1 day ago)
...
- [symfony/ux](https://github.com/symfony/ux) - Symfony UX initiative: a JavaScript ecosystem for Symfony (3 months ago)

#### ⛵ Latest PRs :


- [docs: add tabs for sylius vs sylius stack templatesDir ](https://github.com/Sylius/Stack/pull/316) (OPEN, 1 day ago) [Sylius/Stack](https://github.com/Sylius/Stack) - The Sylius stack is a set of tools for your Symfony projects.
