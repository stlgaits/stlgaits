...
- [Sylius/SyliusGridBundle](https://github.com/Sylius/SyliusGridBundle) ([v1.15.0-ALPHA.1](https://github.com/Sylius/SyliusGridBundle/releases/tag/v1.15.0-ALPHA.1), 5 days ago) - Generic data grids for Symfony applications, support Doctrine and custom drivers, sorting, filtering, actions and field types.
...
- [docs: add tabs for sylius vs sylius stack templatesDir ](https://github.com/Sylius/Stack/pull/316) (OPEN, today) [Sylius/Stack](https://github.com/Sylius/Stack) - The Sylius stack is a set of tools for your Symfony projects.
